...
console.log(missions);
    ...
    useEffect(() => {
      ...
      let temp=exceptionMission.filter((item)=>{daysOff(item.endedAt)>0});
          ...
          <div className="container  table-container-Ex all_table-Ex mt-3 ml-3">
            ...
            {missions.length>0?
              ...
              .map((mission, i) => (
                ...
                <div key={i} className="container-fluid d-flex justify-content-center p-0">
                  <div className="col-1 the_table-Ex text-center">{mission.missionId}</div>
                  <div className="col-1 the_table-Ex text-center">{mission.responsibility}</div>
                  <div className="col-1 the_table-Ex text-center">{mission.title}</div>
                  <div className="col-3 the_table-Ex text-center align-missions-center">
                    <p className="p_taskdetail-Ex p-2 ">
                     {mission.details}
                    </p>
                  </div>
                  <div className="col-1 the_table-Ex  text-center">{mission.endedAt}</div>
                  <div className="col-1 the_table-Ex text-center">{daysOff(mission.endedAt)}</div>
