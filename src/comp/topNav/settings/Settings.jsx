...
export default function Settings() {
  ...
  function addUser() {
    ...
    if (
      ...
      level_1.current.value == "בחר פיקוד..." ||
      level_2.current.value == "בחר..." ||
      level_3.current.value == "בחר..."
    ) {
      setError(true);
    } else {
      setError(false);
        ...
        <div className="container mt-5">
          ...
          {!addNewUser && (
            <div className="bg-white pt-5 pb-5 mt-5">
              ...
              {error && (
                <h5 className="mx-5 text-danger">
                  מלאו את כל השדות המסומנים ב *
                </h5>
              )}
            </div>
          )}
